...
imp3d_opts = struct('outdir', fullfile(out_root, 'image', 'figure_3d'), ...
                    ...
                    'tick_font_size', 10, 'label_font_size', 11, ...
                    'title_font_size', 12);
% Customize 3D-IRF text size anytime:
% imp3d_opts.tick_font_size = 9;   % x/y/z tick labels
% imp3d_opts.label_font_size = 12; % axis labels: horizon/time/IRF
% imp3d_opts.title_font_size = 14; % panel title
